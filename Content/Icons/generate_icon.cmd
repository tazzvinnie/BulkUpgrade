...
set position=+0+20
set text=Mass\nUpgrade
set overlay=MassUpgrade-icon.png
set targetName=MassUpgrade
...
REM convert -verbose "%srcimg%" -fuzz 5%% -transparent #eba448 ( %overlay% -background lightgray -alpha remove -alpha off -virtual-pixel transparent -distort Perspective "0,0,69,84 512,0,124,102 512,512,124,162 0,512,70,140" ) -compose DstOver -composite ^
...
convert -verbose "%srcimg%" ( %overlay% -background lightgray -alpha remove -alpha off -virtual-pixel transparent -distort Perspective "0,0,69,84 512,0,124,102 512,512,124,162 0,512,70,140" ) -compose SrcOver -composite ^
